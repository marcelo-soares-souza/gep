class ModelosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @modelo.save
        format.html { redirect_to @modelo, notice: 'Modelo foi Adicionado.' }
  ...
  def update
    respond_to do |format|
      if @modelo.update(modelo_params)
        format.html { redirect_to @modelo, notice: 'Modelo foi Atualizado.' }
  ...
  def destroy
    @modelo.destroy
    respond_to do |format|
      format.html { redirect_to modelos_url, notice: 'Modelo foi Removido.' }
  ...
  private
    ...
    def modelo_params
      params.require(:modelo).permit(:nome)
    end
end

class TiposController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo.save
        format.html { redirect_to @tipo, notice: 'Tipo foi Adicionado.' }
  ...
  def update
    respond_to do |format|
      if @tipo.update(tipo_params)
        format.html { redirect_to @tipo, notice: 'Tipo foi Atualizado.' }
  ...
  def destroy
    @tipo.destroy
    respond_to do |format|
      format.html { redirect_to tipos_url, notice: 'Tipo foi Removido.' }

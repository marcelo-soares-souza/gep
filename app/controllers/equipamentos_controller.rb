class EquipamentosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @equipamento.save
        format.html { redirect_to @equipamento, notice: 'Equipamento foi Adicionado.' }
  ...
  def update
    respond_to do |format|
      if @equipamento.update(equipamento_params)
        format.html { redirect_to @equipamento, notice: 'Equipamento foi Atualizado.' }
  ...
  private
    ...
    def equipamento_params
      params.require(:equipamento).permit(:item, :patrimonio, :numero_serie, :especificacao, :observacao)
    end
end
